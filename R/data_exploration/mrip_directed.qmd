...
# From the data handbook ----
dom1 <- list(wave=list(c(1,2,3,4,5,6))) 
dirtrips_smackerel <- MRIP.dirtrips(intdir = here("data"), common = 'SPANISH MACKEREL', st = 37, styr = 2020, endyr = 2020, trips = 1, dom = dom1) # okay that worked - figure out how to extract all that data from the internet and build out the sub folders 
```
